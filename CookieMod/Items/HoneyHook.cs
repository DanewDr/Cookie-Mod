	...
	class HoneyHook : ModItem
	{
		public override void SetDefaults()
		{
			...
			*/
			...
			item.shoot = mod.ProjectileType("HoneyHookProjectile");
		}
	}
	class HoneyHookProjectile : ModProjectile
	{
		public override void SetDefaults()
		{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/HoneyHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
