	...
	class ChocolateHook : ModItem
	{
		public override void SetDefaults()
		{
			...
			*/
			...
			item.name = "Chocolate Hook";
			item.shootSpeed = 18f; // how quickly the hook is shot.
			item.shoot = mod.ProjectileType("ChocolateHookProjectile");
		}
	}
	class ChocolateHookProjectile : ModProjectile
	{
		public override void SetDefaults()
		{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/ChocolateHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
