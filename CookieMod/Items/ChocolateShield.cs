...
{
    public class ChocolateShield : ModItem
    {
        ...
        {
            item.name = "Chocolate Shield";      //the name displayed when hovering over the Weapon ingame.
        ...
        {                                        //this is how to craft this item
            ...
            recipe.AddIngredient(null, "ChocolateCookie", 4);       //and 4 lifecristals
