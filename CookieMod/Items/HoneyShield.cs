...
namespace CookieMod.Items     //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class HoneyShield : ModItem
    {
        ...
        {
            item.name = "Honey Shield";      //the name displayed when hovering over the Weapon ingame.
	    ...
	    item.toolTip2 = "8% magic and summoner damage increase";	//The description of the Weapon shown when hovering over the item ingame.
