...
{
    public class BloodCookieTreasurebag : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.height = 24;
            item.rare = 11;
            bossBagNPC = mod.NPCType("BloodCookie");  //add this if the tresure bag is droped from a boss
        ...
        {                                         //below it's a choice from 3 items that will drop randomly
            ...
            player.QuickSpawnItem(mod.ItemType("BloodCookieWings"));				
			if (Main.rand.Next(7) == 0)
			{
				player.QuickSpawnItem(mod.ItemType("BloodCookieMask"));
			}
        }
    }
}
