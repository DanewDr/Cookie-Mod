...
namespace CookieMod.Projectiles
{
	public class ChocolateJavelinProjectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				item = Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<Items.Weapons.ChocolateJavelin>(), 1, false, 0, false, false);
			}
