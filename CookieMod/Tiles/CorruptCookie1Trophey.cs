...
{
	public class CorruptCookie1Trophey : ModTile
	{
		public override void SetDefaults()
		{
			...
			AddMapEntry(new Color(120, 85, 60), "Corrupt Cookie Trophy");
		}
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 16, mod.ItemType("CorruptCookie1Trophy"));
        }
